...
var guestsName = ["Hamza", "Saif", "Alishba", "Saba"];
// adding and removing the variable's value 
var notjoining = guestsName[0];
...
var middleIndex = Math.floor(guestsName.length / 2);
...
guestsName.forEach(function (singlePerson) { return console.log("Hey ".concat(singlePerson, ", I am waiting for you on the dinner table")); });
...
while (guestsName.length > 2) {
    var removingGuests = guestsName.pop();
    console.log("Sorry ".concat(removingGuests, ", you are not invited on dinner table "));
}
//sending invitation to last 2 guests on the table
console.log("Invitations to the last 2 guests");
guestsName.forEach(function (lastTwo) { return console.log("Luckily! ".concat(guestsName, ", you are still invited on the dinner table")); });
